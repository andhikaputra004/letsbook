    ...
    <nav class="navbar navbar-transparent navbar-absolute">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse">
          ...
          <form class="navbar-form navbar-right" role="search" action="<?php echo site_url('transaksi/search');?>" method="post">
                  ...
                  foreach ($list_transaksi as $transaksi)
                  {
                    ...
                    <tbody>
                      <tr>
                        ...
                        <?php                          
                          echo anchor(base_url().'transaksi/detail/'.$transaksi->id_transaksi,'<button type="button" rel="tooltip" title="Read More" class="btn btn-info btn-simple btn-xs">
