              ...
              <div class="card-content">
                <form>               
                    ...
                    <div class="col-md-5">
                      <div class="form-group label-floating">
                        <label class="control-label">Link Lokasi</label>
                          <a class="form-control"  href="<?php echo $link_lokasi; ?>">
                          <?php echo $link_lokasi; ?>";
                          <a>
                      </div>
                    </div>      
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group label-floating">
                        ...
                        <input type="currency" value="<?php echo number_format($harga_tiket)  ?>"  class="form-control" disabled>
                    ...
                    <div class="col-md-3">
                      <div class="form-group label-floating">
                        ...
                        <input type="text" value="<?php echo number_format($biaya_pelayanan); ?>" class="form-control" disabled>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group label-floating">
                        <label class="control-label">Jumlah Tagihan</label>
                        <input type="text" value="<?php echo number_format($tagihan); ?>" class="form-control" disabled>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group label-floating">
                        <b><label class="control-label">Total Pendapatan</label>
                        <input type="text" value="<?php echo number_format(($biaya_pelayanan*$tiket_terjual)); ?>"  class="form-control" disabled>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      <div class="form-group label-floating">
                        ...
                        <textarea class="form-control" rows="2" name="kontak_informasi	" id="kontak_informasi	" disabled required ><?php echo $kontak_informasi	; ?></textarea>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                    <label class="control-label">Surat Izin Penyelenggaraan</label>
                      <div class="image"> 
                        <img src="<?php echo base_url('images/event/izin/'.$gambar_izin );?>" width="300px" height="auto" class="img-rounded"> 
                      </div>
                    </div>
                  </div>
          ...
          <div class="col-md-4">
            <div class="card card-profile">
              ...
              <p class="category">Total Pendapatan</p>
                <h4 class="title"><b><?php echo "Rp ".number_format(($biaya_pelayanan*$tiket_terjual),2,',','.')?></h4>
              </div>        
              ...
              <div class="content">
                ...
                <?php
                  echo anchor(base_url('event/update/'.$id_event),'<button href="#pablo" class="btn btn-primary btn-round">Edit Data Event</button>');
                ?>
              </div>
            </div>
          </div>
